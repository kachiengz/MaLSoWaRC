...
soilData = pd.read_csv('E:/Fall2018/SupportVectorRegression/SoilMositureData/Data/Submit/Code/Test_data/Drying1.csv') #change this to your own directory where the SWRC data is stored
...
# ANN model generation helper function 
...
for epoch in range(training_epochs):
    ...
    if epoch % 20 == 0:
        ...
        print("Epoch:", '%04d' % epoch, "cost=", "{:.9f}".format(c2))
...
for epoch in range(training_epochs):
    ...
    if epoch % 20 == 0:
        ...
        print("Epoch:", '%04d' % epoch, "cost=", "{:.9f}".format(c3))
...
for epoch in range(training_epochs):
    ...
    if epoch % 20 == 0:
        ...
        print("Epoch:", '%04d' % epoch, "cost=", "{:.9f}".format(c4))
...
for epoch in range(training_epochs):
    ...
    if epoch % 20 == 0:
        ...
        print("Epoch:", '%04d' % epoch, "cost=", "{:.9f}".format(c6))
...
for epoch in range(training_epochs):
    ...
    if epoch % 20 == 0:
        ...
        print("Epoch:", '%04d' % epoch, "cost=", "{:.9f}".format(c7))
...
for epoch in range(training_epochs):
    ...
    if epoch % 20 == 0:
        ...
        print("Epoch:", '%04d' % epoch, "cost=", "{:.9f}".format(c8))
...
for epoch in range(training_epochs):
    ...
    if epoch % 20 == 0:
        ...
        print("Epoch:", '%04d' % epoch, "cost=", "{:.9f}".format(c9))
...
for epoch in range(training_epochs):
    ...
    if epoch % 20 == 0:
        ...
        print("Epoch:", '%04d' % epoch, "cost=", "{:.9f}".format(c10))
...
print(predicted_SWC)
predicted_SWC.to_csv('./Output_filesANN_DNN_Layer1-10_predicted_Drying1_SWC_Epoch=5000.csv', encoding='utf-8', index=False)
...
plt.tight_layout()
# 20. Saave the plots
plt.savefig('./Output_files/NeuralNetwork_Drying1_SWC_1-10Hidden-Layers_Epoch=5000.png', bbox_inches="tight")
plt.savefig('./Output_files/NeuralNetwork_Drying1_SWC_1-10Hidden-Layers_Epoch=5000.pdf', bbox_inches="tight")
plt.show()